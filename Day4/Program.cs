...
namespace Day4
{
    ...
    {   
        ...
        private static int Play(List<List<int>> cards, int[] numbers, bool getScoreOfLastWinningCard = false)
        {
        ...
        private static void Draw(List<List<int>> cards, int number)
        {
        ...
        private static void CheckBingo(List<List<int>> cards, List<List<int>> winningCards)
        {
        ...
        private static int CalculateScore(List<int> winningCard, int winningNumber)
        {
            var total = 0;
        ...
        private static List<List<int>> ParseBingoCards(string[] input)
        {
